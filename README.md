...
> *Uma jovem espadachim sem memórias sobre o seu passado esta perdida em outra realidade, buscando voltar para a realidade dos humanos e encontrar as respostas deste universo caótico.*

O projeto nasceu da popularidade crescente dos jogos indie do subgênero metroidvania com elementos souls-like, referências diretas a títulos como **Blasphemous** e **Hollow Knight**. Tendo como meta produzir, com uma equipe pequena e sem experiência prévia em Unity, uma experiência completa de exploração, combate e progressão de atributos.
